				...
				<div class="card-body">
					...
					<form method="POST" action="">
						...
						<div class="input-group">
							<label class="label">CustomerId</label> <input
								class="input--style-4" type="text" name="CustomerId"
								placeholder="CustomerId">
						</div>

						<div class="input-group">
							<label class="label">New password</label> <input
								class="input--style-4" type="text" name="New password"
						...
						<div class="p-t-15">
							<button class="btn btn--radius-2 btn--blue" type="submit">ChangePassword</button>
						</div>
					</form>
				</div>
			</div>
